...
#define CONFIG_FPGA_TDO                 IMX_GPIO_NR(5, 4)
#define CONFIG_FPGA_TDI                 IMX_GPIO_NR(5, 5)
#define CONFIG_FPGA_TMS                 IMX_GPIO_NR(5, 6)
#define CONFIG_FPGA_TCK                 IMX_GPIO_NR(5, 7)
